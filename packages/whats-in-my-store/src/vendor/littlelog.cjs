...
var F = (e, r, o) =>
    r in e
      ? D(e, r, { enumerable: !0, configurable: !0, writable: !0, value: o })
      : (e[r] = o),
  A = (e, r) => {
    for (var o in r || (r = {})) w.call(r, o) && F(e, o, r[o]);
    if (T) for (var o of T(r)) S.call(r, o) && F(e, o, r[o]);
    return e;
  };
...
function C(e, r = 0, o = new Set()) {
  ...
  if (Array.isArray(e)) {
    ...
    for (const [O, y] of Object.entries(e)) {
      const L = O.match(/[^[a-zA-Z_\$]/g)
          ? n.colors.string(`"${$(O)}"`)
          : n.colors.property(O),
        B = C(y, r + 1, new Set([...o]));
      i.push(`${L}${n.colors.equals('=')}${B}`);
    }
    const d = i.join(' '),
      a = r % s.colors.length,
      R = l(s.colors[a], '{'),
